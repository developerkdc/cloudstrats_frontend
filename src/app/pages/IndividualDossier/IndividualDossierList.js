...
import IndividualDossierItem from "./IndividualDossierItem";
      ...
      <Table stickyHeader aria-label="sticky table">
        ...
        <TableBody>
          {filteredRows
            ...
            .map((row, index) => (
              <IndividualDossierItem key={index} row={row} columns={columns} />
            ))}
        </TableBody>
      </Table>
      <TablePagination
...
export default IndividualDossierTable;
