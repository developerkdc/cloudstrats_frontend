          ...
          {({ values, setFieldValue, form, meta }) => (
            <Form noValidate autoComplete="off">
              ...
              >
                ...
                <FormTextField name="disease" label="Disease" />
                <Div sx={outerDiv}>
                  <Typography variant="h5">Date Of Visit</Typography>
                  <DatePickerInput
                    defaultValue={parse(
                      user.date_of_visit,
                      "MM-dd-yyyy",
                    ...
                    onChange={(date) => setFieldValue("date_of_visit", date)}
                ...
                <FormTextField name="name_of_doctor" label="Name Of Doctor" />
                <FormTextField
                  name="medical_report_document"
