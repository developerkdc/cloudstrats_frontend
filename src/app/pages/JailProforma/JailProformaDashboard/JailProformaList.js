...
import JailProformaItem from "./JailProformaItem";

const columns = [
  { id: "sr_no", label: "Sr.No", minWidth: 10, align: "center" },
  { id: "cr_no", label: "CR NO", minWidth: 80, align: "center" },
  {
    id: "year",
    label: "Year",
    minWidth: 170,
      ...
      <Table stickyHeader aria-label="sticky table">
        ...
        <TableBody>
          {filteredRows
            ...
            .map((row, index) => (
              <JailProformaItem key={index} row={row} columns={columns} />
            ))}
        </TableBody>
      </Table>
      <TablePagination
...
export default JailProformaTable;
