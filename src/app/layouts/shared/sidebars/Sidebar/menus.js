...
const menus = [
  ...
  {
    uri: "/manage_customers",
    label: "Customers",
    type: "nav-item",
    icon: <ContactPageOutlinedIcon sx={{ fontSize: 20 }} />,
  },
  {
    label: "Individual Dossier",
    type: "section",
    children: [
  {
    uri: "/individual_unit_dashboard",
    label: "Individual Unit Dashboard",
    type: "nav-item",
    icon: <AccountBoxOutlinedIcon sx={{ fontSize: 20 }} />,
  },]
},
  {
    label: "Organization Dossier",
    type: "section",
    children: [
  {
    uri: "/organization_unit_dashboard",
    label: "Organization Unit Dashboard",
    type: "nav-item",
    icon: <AccountBoxOutlinedIcon sx={{ fontSize: 20 }} />,
  },]
},
  {
    ...
    children: [
      {
        uri: "/jail_unit_dashboard",
        label: "Jail Unit Dashboard",
        type: "nav-item",
        icon: <AccountBoxOutlinedIcon sx={{ fontSize: 20 }} />,
      },
      {
